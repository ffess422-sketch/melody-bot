...
bot.on('message', async (msg) => {
  ...
  try {
    ...
    console.error('Ошибка пользователя:', err);
    return;
  }
  ...
  try {
    ...
    console.error('ОШИБКА В ЛОГИКЕ:', err);
    bot.sendMessage(telegramId, 'Ошибка. Посмотри логи.');
  }
});
